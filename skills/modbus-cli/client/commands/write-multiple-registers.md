...
modbus --json client <endpoint> [client-options] wmr <address> <quantity> <values>
```
...
```bash
modbus --json client localhost wmr 0 3 100,200,300
```
...
```bash
modbus --json client localhost wmr 0 2 0xFF,0x00
```
